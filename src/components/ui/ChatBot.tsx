    ...
    >
      ...
      >
        <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.65)', fontFamily: FONT, lineHeight: 1.75, margin: 0, fontWeight: 400 }}>
          I'm a frontend developer and designer from Castellón, Spain. Studied Software Developer DAM and now building real products full time — I care a lot about the UI <span style={{ color: '#c98a97' }}>feeling right</span>, not just working right.
        </p>
      </motion.div>
      ...
      {[
        ...
        { label: 'Studies',    value: 'Software Developer' },
